...
public class Peibian_state_Monitor_Fragment extends Fragment implements OnChartValueSelectedListener{
    ...
    class ViewHolder{
        ...
        ViewHolder(View view){
            ...
            state.add(guodianya);
            didianya = view.findViewById(R.id.didianya_num);
            state.add(didianya);
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.peibian_state_monitor_fragment,container,false);

        mBarChart = view.findViewById(R.id.mBarChart_1);
    ...
    private void paintXY(){
        IAxisValueFormatter xAxisFormatter = new MyAxisValueFormatter(mBarChart,"peibian");
    ...
    private void setData(ArrayList<BarEntry> yVals1) {
        ...
        if (mBarChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "配变状态监视");
            //设置有五种颜色
