...
import com.sg.xjec.e800.peiyongdian.bean.gson.DasService;
import com.sg.xjec.e800.peiyongdian.bean.gson.Line_Realtime_Statistics;
import com.sg.xjec.e800.peiyongdian.utils.ColorsTemplate;
import com.sg.xjec.e800.peiyongdian.utils.MyApplication;
import com.sg.xjec.e800.peiyongdian.utils.MyAxisValueFormatter;
import com.sg.xjec.e800.peiyongdian.utils.MyValueFormatter;
import com.sg.xjec.e800.peiyongdian.utils.RetrofitUtil;
import com.sg.xjec.e800.peiyongdian.utils.XYMarkerView;
...
public class Line_state_Monitor_Fragment extends Fragment implements OnChartValueSelectedListener{
    ...
    private Line_Realtime_Statistics statistics;
    private DasService translation;
    ...
    private void paintXY(){
       ...
       // leftAxis.setDrawGridLines(false);
        ...
        //获取数据
        Retrofit retrofit = RetrofitUtil.RETROFIT.getRetrofit();
        //创建请求网络接口的实例
        GetRequest_Interface request = retrofit.create(GetRequest_Interface.class);
        //对发送的请求进行封装
        Call<DasService> call = request.getCall();
        //发送网络请求异步
        call.enqueue(new Callback<DasService>() {
            @Override
            public void onResponse(Call<DasService> call, Response<DasService> response) {
                translation = response.body();
                Log.d("emmm", "paintXY: "+translation.get_$1());
                //模拟数据

               // yVals1.add(new BarEntry(0, 0));
                /*yVals1.add(new BarEntry(1, 30));
                yVals1.add(new BarEntry(2, 37));
                yVals1.add(new BarEntry(3, 45));
                yVals1.add(new BarEntry(4, 34));
                yVals1.add(new BarEntry(5, 56));
            ...
            @Override
            public void onFailure(Call<DasService> call, Throwable t) {
    ...
    private void setData(ArrayList<BarEntry> yVals1) {
        ...
        if (mBarChart.getData() != null &&
            ...
            //设置有五种颜色
            set1.setColors(ColorsTemplate.Line_COLORS);
    ...
    public interface GetRequest_Interface{
       // @GET(PathConstants.LINE_REALTIME_STATISTICS)
        @GET("dasService/getData/0")
        Call<DasService> getCall();
    }
